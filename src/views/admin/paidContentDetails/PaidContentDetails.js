        ...
        <>
            ...
            <Box pt={{ base: "130px", md: "80px", xl: "80px" }}>
                ...
                <div className="cstm_brand_txt">
                    <Text className="brnd_txt">{Details?.is_deleted ? "Deleted Content" : Details?.amount_paid
                        ? "Transactions details" : "Posted Content"}</Text>
                </div>
                <Card
                    direction="column"
                    w="100%"
                                            ...
                                            <SwiperSlide key={index}>
                                                {curr?.media_type === "image" ? (
                                                    <img
                                                        src={
                                                            curr?.watermark ||
                                                            process.env.REACT_APP_NEW_URL_BEFORE_PUBLISHED + curr?.media
                                                        }
                                                        alt=""
