...
function SortFilterContent(props) {
    ...
    <div className="sort_filter_wrap">
      ...
      <Flex mb={"30px"} direction={"column"} gap={"10px"}>
        ...
        >
          ...
          <Flex gap="8px">
            <butto style={{ background: "none", border: "none" }} className="fltr_actn"
              onClick={() => handleSortClick('Licence_search', 'Exclusive')}
            >
              <Text>Exclusive</Text>
              <img src={closeic} alt="cross" />
            </butto >
            <butto style={{ background: "none", border: "none" }} className="fltr_actn active"
