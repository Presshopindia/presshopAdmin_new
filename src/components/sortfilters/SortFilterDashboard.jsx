...
function SortFilterDashboard(props) {
  ...
  return (
    <div className="sort_filter_wrap">
      ...
      >
        ...
        <button style={{background:"none", border:"none"}} className="link" onClick={handleClear}>Clear all</button>
      </Flex>
...
export default SortFilterDashboard